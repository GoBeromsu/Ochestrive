...
## 역할 담당
**고범수**: PM, 백엔드-webRTC 화상 채팅, 동기화 알고리즘 구현, 리팩토링 @GoBeromsu  
**김명지**: 백엔드-webRTC 화상 채팅, 컨트롤러 구현, 리팩토링, Docker 환경 구축 @Starlight258  
**김지민**: 프론트엔드- 웹 만들기, Docker 환경 구축 @kimjimin00    
**류한일**: 백엔드-media device I/O 처리, 동기화 알고리즘 구현 @cooopang      
